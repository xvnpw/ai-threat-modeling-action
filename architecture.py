...
class DataFlow(BaseModel):
    data_flow: str = Field(description="Name of data flow, e.g. Data flow 1: Client -> Container A, Data flow 2: Container A -> Container B")
    source_of_data_flow: str = Field(description="Source of data flow, e.g. Client")
    destination_of_data_flow: str = Field(description="Destination of data flow, e.g. Container A")
...
class DataFlowAnalyzer:
    ...
    def list_data_flow_for_architecture(self, args, docs_all) -> List[str]:
...
class ArchitectureAnalyzer:
    ...
    def analyze_architecture(self, args, inputs: Path, output: Path):
        ...
        data_flows = self.data_flow_analyzer.list_data_flow_for_architecture(args, docs_all)
